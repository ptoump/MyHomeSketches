...
const long scale_constant = 1100 * (4580 / 4688.) * 1023L ;
...
const long batt_period = 190 * 1000L;
...
{ 
  ...
  DEBUG_Local_PRINTLN(scale_constant);
...
void reportBat() {
    ...
    DEBUG_Local_PRINT("Battery voltage: "); DEBUG_Local_PRINT(batteryVolt); DEBUG_Local_PRINTLN(" mV");
    uint8_t batteryPcnt = constrain(map(batteryVolt,VMIN,VMAX,0,100),0,255);   
    DEBUG_Local_PRINT("Battery percent: "); DEBUG_Local_PRINT(batteryPcnt); DEBUG_Local_PRINTLN(" %");
